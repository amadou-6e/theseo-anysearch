...
|---|---:|---|
| `mode` | `discrete_26` | Selects the action representation. Accepted values are `discrete_6`, `discrete_18`, `discrete_26`, `multi_discrete`, and `vector_3`. |
...
`multi_discrete` exposes `MultiDiscrete([3, 3, 3])`; components map from
