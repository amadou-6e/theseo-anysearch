...
import typer
from theseo_anysearch.experiments.execution_recipe import ExecutionRecipe, clone as clone_recipe, validate
...
def apply(recipe: Path = typer.Argument(..., exists=True, dir_okay=False),
    ...
    result = validate(ExecutionRecipe.load(recipe), world)
