...
V2R2_PROGRAM = "voxel-encoder-pilot-v2r2"
LOCAL_PROGRAM = "voxel-encoder-local-geometry-v1"
...
def make_pilot_observation(
    ...
    *,
    ...
    if program not in {V1_PROGRAM, V2_PROGRAM, V2R1_PROGRAM, V2R2_PROGRAM, LOCAL_PROGRAM}:
