...
- `evaluation_waypoint_completion_fraction`: reached waypoints divided by configured route waypoints across the evaluation episodes. For a single 150-waypoint route, this is `waypoints_reached / 150`.
