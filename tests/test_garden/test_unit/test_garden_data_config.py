...
class TestRandomBoxesSamplerConfig:
    """Tests RandomBoxesSamplerConfig."""
    def test_type_literal(self):
...
class TestPositionSampleSourceConfig:
    """Tests PositionSampleSourceConfig."""
    def test_type_literal(self):
